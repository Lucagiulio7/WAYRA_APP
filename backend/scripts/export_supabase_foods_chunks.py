"""
Generate smaller SQL Editor friendly chunks for traditional foods.

Usage:
    cd backend
    python scripts/export_supabase_foods_chunks.py
"""
...
def main() -> None:
    ...
    for stale in OUT_DIR.glob("102b_*_seed_foods.sql"):
        stale.unlink()
    ...
    for index, chunk in enumerate(CHUNKS, start=1):
        ...
        out_path = OUT_DIR / f"102b_{index:02d}_seed_foods.sql"
