...
function builderMapHelp(lang: string) {
  ...
  const item = (icon: ContextHelpContent["icon"], title: Record<string, string>, body: Record<string, string>): ContextHelpContent => ({
    icon,
    title: tx(title),
    body: tx(body),
  });
...
export function BuilderMap({
  ...
  // â”€â”€ Transizione pannello con fade â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
const styles = StyleSheet.create({
  ...
  panel: { borderTopWidth: 1 },  // height Ã¨ dinamica via inline style (useWindowDimensions)
  panelInner: { flex: 1 },
  panelHeader: {
    flexDirection: "row",
    alignItems: "center",
